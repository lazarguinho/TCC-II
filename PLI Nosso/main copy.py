...
CSV_AGREGADO = pasta_saida / "_resultados_nosso.csv"
...
def processar_arquivo(arquivo_path: Path):
    ...
    return (vertex_count, edge_count, density, max_degree, min_degree, elapsed_ms, lambda_val, label_status, best_bound, gap, bb_nodes)
