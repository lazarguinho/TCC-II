...
\usepackage{amsfonts, amssymb, amsmath, amsthm}     % Fonte e símbolos matemáticos
...
\usepackage[portuguese, ruled, linesnumbered]{algorithm2e}    % Escrever algoritmos
\usepackage{algorithmic}                            % Criar Algoritmos  
\usepackage{lib/optidef-local}
...
\usepackage[normalem]{ulem} % necessário para \sout

\newcommand{\del}[1]{\textcolor{red}{\sout{#1}}}

\newcommand{\atilio}[1]{\textcolor{blue}{#1}}

\newcommand{\comentario}[1]{\textcolor{brown}{#1}}
