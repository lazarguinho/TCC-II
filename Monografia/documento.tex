...
\autor{Mateus Campelo Pedrosa}
\titulo{Aplicação de Algoritmos Genéticos ao Problema de Rotulação–L(2,1) em Grafos}
\data{2025}
\local{Quixadá}
...
\membrodabancadois{Prof. Me. Arthur Rodrigues Araruna}
% \membrodabancadoiscentro{Faculdade de Filosofia Dom Aureliano Matos (FAFIDAM)}
\membrodabancadoisies{Universidade Federal do Ceará (UFC)}
\membrodabancatres{Prof. Dr. Criston Pereira de Souza}
